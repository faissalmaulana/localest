        ...
        <div class="card bg-base-100 shadow-md">
            <div class="card-body">
                ...
                <p class="text-sm text-base-content/70">
                    Add Your Favorite Place to {{$city->name}}
                </p>
                ...
                <form method="POST" action="/places" enctype="multipart/form-data">
                    ...
                    <div class="form-control mt-6">
                        <fieldset class="fieldset">
                            ...
                            <textarea class="textarea h-24 w-full" name="notes"></textarea>
                    ...
                    <div class="flex justify-end gap-3 mt-8">
                        ...
                        <button type="submit" class="btn btn-primary" onclick="return confirm('Are you sure you want to add this place ?')">
                            Add Place
                        </button>
                    </div>
